...
```bash
grep -A4 '^## F-'       __LEDGER_PATH__   # all findings
grep -A4 '· OPEN ·'     __LEDGER_PATH__   # everything still open
grep -A4 '· retired ·'  __LEDGER_PATH__   # do not re-propose these
grep -B1 -A4 '<topic>'  __LEDGER_PATH__   # everything about one topic
```
